...
var menuRotate = setInterval(function() {
	...
	switch(counter) {
		case 2: case 3: case 4: case 6: case 7: case 8: case 9: case 11:
...
let i = 0;
function animate() {
	let p2diff = (currentStateP2 === punch) ? window.innerWidth * 0.069 : (currentStateP2 === walkingf) ? window.innerWidth * 0.04 : 0;
	...
	if (elapsed > fpsInterval) {
		...
		if ((currentStateP1 === punch || currentStateP1 === hit) && i == currentStateP1.frames - 1) {
			i = 0;
			currentStateP1 = stance;
		}
		else if (i == currentStateP1.frames - 1 && (currentStateP1 !== punch || currentStateP1 !== hit)) {
			i = 0;
		}
		else {
			i++;
		}
		if ((currentStateP2 === punch || currentStateP2 === hit) && j == currentStateP2.frames - 1) {
			j = 0;
			currentStateP2 = stance;
		}
		else if (j == currentStateP2.frames - 1 && (currentStateP2 !== punch || currentStateP2 !== hit)) {
			j = 0;
		}
		else {
			j++;
...
function preloadAll() {
	...
	for (let o = 0; o < walkingf.frames; o++) {
	...
	for (let o = 0; o < walkingb.frames; o++) {
